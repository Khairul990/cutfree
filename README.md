...
<p align="center">
  ...
  <br><em>প্রিভিউ · ইন/আউট হ্যান্ডেল সহ টাইমলাইন · এক্সপোর্ট প্যানেল</em>
</p>

<details>
<summary>📸 আরও স্ক্রিনশট (খালি অবস্থা · এক্সপোর্ট চলছে · ফিচার · মোবাইল)</summary>

| | |
| --- | --- |
| ![শুরু করুন](docs/screenshot-empty.png) | ![এক্সপোর্ট চলছে](docs/screenshot-exporting.png) |
| ![ফিচার](docs/screenshot-features.png) | ![মোবাইল](docs/screenshot-mobile.png) |
...
| 🎬 স্যাম্পল ক্লিপ | কোনো ফাইল ছাড়াই টুলটা পরখ করুন — এক ক্লিকে ব্রাউজারেই ডেমো ক্লিপ তৈরি হয় |
...
1. `index.html` (বা `cutfree.html`) ব্রাউজারে খুলুন। হাতে কোনো ভিডিও না থাকলে
   **“🎬 স্যাম্পল ক্লিপ বানান”** চাপুন — অ্যাপটা ব্রাউজারেই ৫ সেকেন্ডের একটা ক্লিপ বানিয়ে দেবে।
...
├── tests/e2e.js                   # Playwright এন্ড-টু-এন্ড টেস্ট (২৫টি চেক)
├── docs/                          # স্ক্রিনশট
...
npm test                    # index.html-এর বিরুদ্ধে ২৫টি চেক
...
তারপর স্যাম্পল ক্লিপ → যোগ → প্লে → ট্রিম → স্প্লিট → mute → রি-অর্ডার → ডিলিট →
এক্সপোর্ট → ভাষা টগল → ক্লিয়ার — সব ধাপ যাচাই করে, এবং নিশ্চিত করে যে এক্সপোর্ট করা ফাইলটা
